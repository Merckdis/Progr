...
public class Executor {
    ...
    public Executor(List<String> poliz){
        this.poliz = poliz;
    ...
    private void write(Object obj){
        System.out.println( "\n" + obj.toString() + " = " + this.variables.get(obj));
    }
        ...
        while (this.pos < this.poliz.size()){
            ...
            if (stackHead.equals("!")){
                ...
                if (!Boolean.valueOf(this.stack.remove(this.stack.size() - 1).toString()))
                    this.pos = addr;
            } else if (stackHead.equals("write")) {
                this.write(this.stack.remove(this.stack.size() - 1));
            } else if (stackHead.equals("read")){
                this.read(this.stack.remove(this.stack.size() - 1));
